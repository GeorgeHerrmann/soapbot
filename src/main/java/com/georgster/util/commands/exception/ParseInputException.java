...
/**
 * A {@link CommandParserException} thrown when an input String for a {@link NewCommandParser}
 * does not match the parser's pattern and or rules when parsing the input.
 * <p>
 * <b>Note:</b> This exception can only be thrown if the {@link NewCommandParser} has required arguments.
...
public class ParseInputException extends CommandParserException {
     ...
     * @param parser The {@link NewCommandParser} for which the configuration did not match the {@code attemptedInput}.
     */
    public ParseInputException(String attemptedInput, NewCommandParser parser) {
